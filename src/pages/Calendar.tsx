  ...
  return (
    <Layout>
      <div className="container py-8">
        <div className="mb-8">
          <h1 className="font-playfair text-3xl font-bold mb-2">Academic Event Calendar</h1>
          <p className="text-muted-foreground">Browse upcoming academic events across India</p>
        </div>
