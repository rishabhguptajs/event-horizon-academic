    ...
    <footer className="bg-gradient-to-r from-[#e7f9e7] via-[#F2FCE2] to-[#FFE29F] border-t shadow-inner">
      <div className="container py-10 md:py-16">
          ...
          <div className="md:col-span-1">
            <Link to="/" className="flex items-center gap-2">
              <img
                ...
                style={{ minWidth: 24 }}
              />
              <span className="font-playfair text-2xl font-bold text-[#6E59A5]">
                eventsphere
              </span>
            </Link>
            <p className="mt-4 text-sm text-[#6E59A5]/90">
              India's academic event gateway – connecting students, faculty, &
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <Link
                  to="/events"
                  className="text-muted-foreground hover:text-[#9b87f5] transition-colors"
                >
                  All Events
                </Link>
              </li>
        ...
        <div className="mt-10 pt-6 border-t text-center text-sm text-[#221F26]/70">
          <p>
            &copy; {new Date().getFullYear()} eventsphere • Made with{" "}
            <span className="text-[#F97316]">♥</span> in India • All rights
            reserved.
          </p>
        </div>
      </div>
